 ...
 */
final class Version20220411093706 extends AbstractMigration
{
    /**
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, seller_id INT DEFAULT NULL, sku VARCHAR(255) NOT NULL, price VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, reviews_count INT DEFAULT NULL, created_date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', updated_date DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', INDEX IDX_D34A04AD8DE820D9 (seller_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
